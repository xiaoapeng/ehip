 ...
 * 通用帧内存块大小
 */
#ifndef EHIP_NETDEV_TYPE_GENERAL_POOL_BUFFER_SIZE
#define EHIP_NETDEV_TYPE_GENERAL_POOL_BUFFER_SIZE              1518U
#endif

/*
 * 通用帧内存块数量
 */
#ifndef EHIP_NETDEV_TYPE_GENERAL_POOL_BUFFER_NUM
#define EHIP_NETDEV_TYPE_GENERAL_POOL_BUFFER_NUM               12U
#endif

/**
 * 通用帧内存块对齐大小
 */
#ifndef EHIP_NETDEV_TYPE_GENERAL_POOL_BUFFER_ALIGN
#define EHIP_NETDEV_TYPE_GENERAL_POOL_BUFFER_ALIGN             16U
#endif

/*
 *  POLL BUFFER 句柄最大数量，要大于 EHIP_NETDEV_TYPE_GENERAL_POOL_BUFFER_NUM
 */
...
#define EHIP_NETDEV_MAX_IP_NUM                                  3U
#endif
...
#define ETH_MULTICAST_ADDR_NUM                                  2U
#endif
